...
{
    public class TestScenarioDataProvider : ITestScenarioDataProvider
    {
        private readonly QcsProductContext _context;

        public TestScenarioDataProvider(QcsProductContext context)
        {
            _context = context;
        }
        ...
        public async Task<List<TestScenarioViewModel>> GetListTransaction(string search, List<int> GradeRoomId)
        {
        ...
        public async Task<List<TestScenario>> GetListExist()
        {
        ...
        public async Task<List<TransactionTestScenario>> GetList()
        {
            return await (from sc in _context.TransactionTestScenario
                          select sc).ToListAsync();
        }
